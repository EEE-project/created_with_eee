...
app = marimo.App(width="medium", app_title="Одиссея с Гомером — День 5: Одиссея IX.105–129")
...
def _(
    ...
    _tp_path = gu.ensure_file(
        "translation_presence.tsv", nb_dir=_P(__file__).parent, remote_base=cfg.nb_remote("2026_07_13"),
    )
...
def _(cfg, gu):
    ...
    NB_REMOTE = cfg.nb_remote("2026_07_13")
    for _f in (
        'Od_IX_105-129.pdf',
