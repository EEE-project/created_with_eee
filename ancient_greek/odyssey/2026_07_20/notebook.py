...
def _(eee, mo):
    ...
    _badge = "[![Open in molab](https://molab.marimo.io/molab-shield.svg)](https://molab.marimo.io/notebooks/nb_bdF84qih8ddcDY18APJs6D)"
    _left = mo.vstack([
...
def _(ag_backend, eee, grc_lexicons, gu):
    ...
    QUIZ_WORDS_RAW = gu.resolve_word_grammar(
        gu.load_inflected_vocab_tsv("vocab_IX_130-151.tsv", nb_dir=Path(__file__).parent),
        ag_backend, "ru"
    )
...
def _(cfg, gu):
    ...
    NB_REMOTE = f"{cfg.raw_base}/2026_07_20"
    for _f in (
        'Od_IX_130-151.pdf',
