...
def _(mo):
    ...
    **Palaestra — Древнегреческий язык, начальный уровень — Лето 2026**
    ...
    [![Open in molab](https://molab.marimo.io/molab-shield.svg)](https://molab.marimo.io/notebooks/nb_s9jEY8Ku8zq1P21gJegFnA)
    """)
    return
...
def _(cfg, mo):
    ...
    GreekUtils.ensure_file(_noun_yaml.name, nb_dir=_noun_yaml.parent, remote_base=cfg.raw_base)
