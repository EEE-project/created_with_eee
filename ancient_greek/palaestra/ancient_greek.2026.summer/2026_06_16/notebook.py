...
app = marimo.App(width="medium", app_title="Palaestra — Занятие 3 · 16.06.2026: Глаголы и синтаксис")
...
def _(NB_REMOTE, mo):
    mo.md(f"""
    **Материалы занятия:** [дз+энклитики+заметки.pdf]({NB_REMOTE}/дз+энклитики+заметки.pdf) · [κεφ\\_Ι(0,5)\\_ἀσκήματα.pdf]({NB_REMOTE}/κεφ_Ι(0,5)_ἀσκήματα.pdf) · [энклитики+немного\\_алфавита\\_и\\_практики\\_письма.pdf]({NB_REMOTE}/энклитики+немного_алфавита_и_практики_письма.pdf) · [Athenaze\\_1\\_vocabula.pdf]({NB_REMOTE}/Athenaze_1_vocabula.pdf)
    """)
    return
...
def _(mo):
    ...
    **Ἆρα…; — Разве? (да/нет):**
    ...
    Частицы стоят **на втором месте** (закон Ваккернагеля): γάρ, οὖν.
...
def _(cfg, mo):
    ...
    _prev_url, _next_url = cfg.adjacent_urls("2026_06_16/")
