...
app = marimo.App(width="medium", app_title="Palaestra — Занятие 10 · 10.07.2026: Прилагательные и инфинитив")
...
@app.cell(hide_code=True)
def _(NB_REMOTE, mo):
    _prev_remote = NB_REMOTE.replace("/2026_07_10", "/2026_07_03")
    mo.md(f"""
...
def _(cfg, mo):
    ...
    _prev_url, _next_url = cfg.adjacent_urls("2026_07_10/")
