...
@app.cell(hide_code=True)
def _(NB_REMOTE, mo):
    mo.md(f"**Материалы занятия:** [Κεφ.I(1).pdf]({NB_REMOTE}/Κεφ.I(1).pdf) · [заметки\\_19.06.pdf]({NB_REMOTE}/заметки_19.06.pdf) · [κεφ\\_Ι(0,5)\\_ἀσκήματα\\_τέλος.pdf]({NB_REMOTE}/κεφ_Ι(0,5)_ἀσκήματα_τέλος.pdf) · [энклитики+немного\\_алфавита\\_и\\_практики\\_письма\\_τέλος.pdf]({NB_REMOTE}/энклитики+немного_алфавита_и_практики_письма_τέλος.pdf)")
    return
