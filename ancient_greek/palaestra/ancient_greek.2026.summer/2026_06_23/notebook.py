...
app = marimo.App(width="medium", app_title="Palaestra — Занятие 5 · 23.06.2026: Спряжение и падежи")
...
@app.cell(hide_code=True)
def _(NB_REMOTE, mo):
    _next_remote = NB_REMOTE.replace("/2026_06_23", "/2026_06_26")
    mo.md(fr"""
    ## Проверка домашнего задания · τὸ τρίτον προστεταγμένον

    ### Μελετήματα · упражнения 1.4, 1.5, 1.6, 1.8

    [κεφ.I, (3)\_ἀσκήματα\_τέλος.pdf]({_next_remote}/κεφ.I, (3)_ἀσκήματα_τέλος.pdf) — файл с ответами.
    """)
    return
...
def _(cfg, mo):
    ...
    _prev_url, _next_url = cfg.adjacent_urls("2026_06_23/")
