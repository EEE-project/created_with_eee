...
def _(mo):
    mo.md(r"""
    # Δίδαγμα θ' · Κεφάλαιον II
    **Palaestra — Древнегреческий язык, начальный уровень — Лето 2026**

    [![Open in molab](https://molab.marimo.io/molab-shield.svg)](https://molab.marimo.io/notebooks/nb_AqbW1NhY9vipJKsDmPCTyL)
    """)
    return
...
def _(mo):
    ...
    **προσάπτω** = πρός + ἅπτω (= λαμβάνω), сочетается и с πρός + αἰτ., и просто с dat.:
