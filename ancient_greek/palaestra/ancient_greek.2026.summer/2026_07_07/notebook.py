...
def _(mo):
    ...
    **2 лицо:**
    ...
    σύ πόνει (πόν-ε-ε → πονεῖ) → πονεῖτε · ὁ δοῦλος πονεῖ → πονεῖτε
...
def _(mo):
    ...
    **ἔωθεν** = ἡ ἔως + -θεν («с рассвета»): *ἐπεὶ ὁ ἥλιος ἀνατέλλει* (ἀνατέλλω ↔ καταδύνω)
...
def _(cfg, mo):
    ...
    NB_REMOTE = f"{cfg.raw_base}/2026_07_07"
