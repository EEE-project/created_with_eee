...
def _(mo):
    ...
    **Γραμματική:** Συνεχής Μέλλοντας · Χρονικές προτάσεις
...
def _(gu, mo):
    ...
    tense_selector = mo.ui.dropdown(
        ...
        value=f"{gu.TENSE_LABELS['future_continuous']['greek']} (Συνεχής Μέλλοντας)",
