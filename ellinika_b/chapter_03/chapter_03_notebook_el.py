...
@app.cell(hide_code=True)
def _(mo):
    file_upload_noun = mo.ui.file(filetypes=[".tsv"], label="Φόρτωση nouns.tsv (προαιρ.)")
    file_upload_noun
...
@app.cell(hide_code=True)
def _(mo):
    file_upload_verb = mo.ui.file(filetypes=[".tsv"], label="Φόρτωση verbs.tsv (προαιρ.)")
    file_upload_verb
...
@app.cell(hide_code=True)
def _(mo):
    file_upload_adj = mo.ui.file(filetypes=[".tsv"], label="Φόρτωση adjectives.tsv (προαιρ.)")
    file_upload_adj
