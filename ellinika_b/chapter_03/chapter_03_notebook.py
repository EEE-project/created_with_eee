...
def _(language_selector, mo):
    ...
    _badge = "[![Open in molab](https://molab.marimo.io/molab-shield.svg)](https://molab.marimo.io/notebooks/nb_vTKHaTAEKdaKDeiYuhzAmD)"
    if _lang == "ru":
    ...
    _gc = "Αόριστες Αντωνυμίες (κάποιος/κανένας) · Δεικτικές (ίδιος/τέτοιος/τόσος)"
