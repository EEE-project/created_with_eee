...
@app.cell(hide_code=True)
def _(mo):
    file_upload_noun = mo.ui.file(filetypes=[".tsv"], label="Загрузить nouns_ru.tsv (необяз.)")
    file_upload_noun
...
@app.cell(hide_code=True)
def _(mo):
    file_upload_verb = mo.ui.file(filetypes=[".tsv"], label="Загрузить verbs_ru.tsv (необяз.)")
    file_upload_verb
...
@app.cell(hide_code=True)
def _(mo):
    file_upload_adj = mo.ui.file(filetypes=[".tsv"], label="Загрузить adjectives_ru.tsv (необяз.)")
    file_upload_adj
