...
app = marimo.App(
    app_title="Καποδίστριας — Μάθημα 1 · 01/05/2026: Ο Πρώτος Κυβερνήτης της Ελλάδας",
    width="medium",
...
def _(RAW_BASE, gu, language_selector, mo, notebook_dir):
    ...
    if _lang == "ru":
        _c = mo.vstack([
            ...
            *   Его фамилия имеет итальянское происхождение (**Capo d'Istria**) и означает «из Истрии» — региона в современной Словении/Хорватии; его первоначальная фамилия была «Виттори».
            """),
            _img(3),
            _img(4),
            mo.md(r"""
