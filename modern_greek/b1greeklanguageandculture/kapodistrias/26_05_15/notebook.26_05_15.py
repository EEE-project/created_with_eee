...
def _(RAW_BASE, gu, language_selector, mo, notebook_dir):
    ...
    if _lang == "ru":
        _c = mo.vstack([
            ...
            _img(1),
            mo.md(r"""
            ### **Возрождение Греции Иоанном Каподистриасом**

            #### **1. Положение страны**
            Когда Каподистриас принял управление, Греция была **разрушенной и опустошённой войной страной**. В своём письме он отмечал, что Греция «лишена всего» — не было ни денег, ни школ, ни управления. Главными проблемами были **голод**, **бедность** и отсутствие безопасности и законов.
            """),
            _img(2),
            mo.md(r"""
            #### **2. Социальная забота и образование**
            Губернатор твёрдо верил, что **образование** — это ключ к изменению будущего страны.
            *   **Школы и сиротские приюты:** Он основал школы и сиротские приюты, чтобы защитить и обучить детей, потерявших родителей на войне.
            *   **Военное образование:** Основал **Школу эвелпидов** (1828) для организации армии.
            """),
            _img(3),
            mo.md(r"""
            #### **3. Экономика и сельское хозяйство**
            Каподистриас старался организовать экономику и помочь народу выжить:
            *   **Валюта:** Создал первую греческую валюту — **феникс**. Название символизировало Грецию, возрождающуюся из пепла, как мифическая птица.
            *   **Картофель:** Поддержал сельское хозяйство и ввёл **выращивание картофеля**, так как народ голодал и нужно было быстрое решение продовольственной проблемы.
            """),
            _img(4),
            _img(5),
            mo.md(r"""
            #### **4. Цель управления**
            Конечной целью было создание **сильного, независимого и организованного государства** со справедливыми законами и стабильностью.
            """),
            _img(6),
            mo.md(r"""
            ### **Основная лексика (Занятие 15/5/2026)**
            *   **Ουσιαστικά:** κράτος (государство), φτώχεια (бедность), πείνα (голод), εκπαίδευση (образование), ορφανοτροφείο (сиротский приют), νόμος (закон), νόμισμα (монета/валюта), φοίνικας (феникс), γεωργία (сельское хозяйство), αναγέννηση (возрождение), στάχτη (пепел).
            *   **Ρήματα:** οργανώνω (организовывать), βοηθάω (помогать), αλλάζω (менять), στηρίζω (поддерживать), δημιουργώ (создавать), κυβερνώ (управлять), προστατεύω (защищать), ιδρύω (основывать), καλλιεργώ (выращивать), βελτιώνω (улучшать), διαχειρίζομαι (управлять/распоряжаться), καταστρέφω (разрушать), ξαναγεννιέμαι (возрождаться).
            *   **Επίθετα:** οργανωμένος (организованный), φτωχός (бедный), σημαντικός (важный), δίκαιος (справедливый), κατεστραμμένος (разрушенный), ασφαλής (безопасный), ισχυρός (сильный), ανεξάρτητος (независимый), σταθερός (стабильный), καινούριος (новый).

            ### **Полезные фразы**
            *   **Πιστεύω ότι…** — Я верю, что…
            *   **Κατά τη γνώμη μου…** — По моему мнению…
            *   **Το πιο σημαντικό είναι…** — Самое важное это…
            *   **Νομίζω πως…** — Я думаю, что…
            *   **Συμφωνώ / Διαφωνώ γιατί…** — Я согласен / не согласен, потому что…
            *   **Το πιο σημαντικό είναι…** — Самое главное — это…
            *   **Μια χώρα χρειάζεται…** — Стране нужно…
            *   **Η εκπαίδευση μπορεί να…** — Образование может…
            *   **το κατεστραμμένο κτίριο** — разрушенное здание
            """),
        ])
    elif _lang == "el":
        _c = mo.vstack([
            ...
            *   **Το πιο σημαντικό είναι…** — Самое главное — это… / The most important thing is…
        ...
        _c = mo.vstack([
            ...
            _img(1),
            mo.md(r"""
            ### **The Rebirth of Greece by Ioannis Kapodistrias**

            #### **1. The State of the Country**
            When Kapodistrias took over governance, Greece was a **devastated and war-torn country**. He wrote in a letter that Greece "lacks everything" — there was no money, no schools, and no governance. The main problems were **hunger**, **poverty**, and the absence of security and laws.
            """),
            _img(2),
            mo.md(r"""
            #### **2. Social Welfare and Education**
            The Governor firmly believed that **education** is the key to changing the future of a country.
            *   **Schools and Orphanages:** He founded schools and orphanages to protect and educate children who had lost their parents in the war.
            *   **Military Education:** He founded the **School of Evelpidon** (1828) to organise the army.
            """),
            _img(3),
            mo.md(r"""
            #### **3. Economy and Agriculture**
            Kapodistrias worked to organise the economy and help the people survive:
            *   **Currency:** He created the first Greek currency — the **phoenix**. The name symbolised Greece being reborn from the ashes, like the mythical bird.
            *   **The Potato:** He supported agriculture and introduced **potato cultivation**, because the people were starving and needed an immediate food solution.
            """),
            _img(4),
            _img(5),
            mo.md(r"""
            #### **4. Goal of Governance**
            His ultimate goal was to create a **strong, independent, and organised state** with fair laws and stability.
            """),
            _img(6),
            mo.md(r"""
            ### **Key Vocabulary (Lesson 15/5/2026)**
            *   **Nouns:** κράτος (state), φτώχεια (poverty), πείνα (hunger), εκπαίδευση (education), ορφανοτροφείο (orphanage), νόμος (law), νόμισμα (coin/currency), φοίνικας (phoenix), γεωργία (agriculture), αναγέννηση (rebirth), στάχτη (ash).
            *   **Verbs:** οργανώνω (to organise), βοηθάω (to help), αλλάζω (to change), στηρίζω (to support), δημιουργώ (to create), κυβερνώ (to govern), προστατεύω (to protect), ιδρύω (to found), καλλιεργώ (to cultivate), βελτιώνω (to improve), διαχειρίζομαι (to manage), καταστρέφω (to destroy), ξαναγεννιέμαι (to be reborn).
            *   **Adjectives:** οργανωμένος (organised), φτωχός (poor), σημαντικός (important), δίκαιος (fair/just), κατεστραμμένος (devastated), ασφαλής (safe), ισχυρός (strong), ανεξάρτητος (independent), σταθερός (stable), καινούριος (new).

            ### **Useful Phrases**
            *   **Πιστεύω ότι…** — I believe that…
            *   **Κατά τη γνώμη μου…** — In my opinion…
            *   **Το πιο σημαντικό είναι…** — The most important thing is…
            *   **Νομίζω πως…** — I think that…
            *   **Συμφωνώ / Διαφωνώ γιατί…** — I agree / disagree because…
            *   **Μια χώρα χρειάζεται…** — A country needs…
            *   **Η εκπαίδευση μπορεί να…** — Education can…
            *   **το κατεστραμμένο κτίριο** — the destroyed building
            """),
        ])
    _c
    return
...
def _(RAW_BASE, file_upload_noun, gu, notebook_dir):
    df_noun = gu.load_vocab_table("nouns.tsv", nb_dir=notebook_dir, remote_base=RAW_BASE, file_upload=file_upload_noun)
    return (df_noun,)
...
def _(language_selector, mo):
    ...
    _prev_url, _next_url = _cfg.adjacent_urls("26_05_15/")
...
def _():
    ...
    RAW_BASE = "https://raw.githubusercontent.com/EEE-project/created_with_eee/main/modern_greek/b1greeklanguageandculture/kapodistrias/26_05_15"
