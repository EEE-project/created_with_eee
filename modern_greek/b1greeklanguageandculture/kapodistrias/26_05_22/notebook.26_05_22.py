...
app = marimo.App(
    app_title="Καποδίστριας — Μάθημα 4 · 22/05/2026: Το Τέλος του Καποδίστρια",
    width="medium",
...
def _(language_selector, mo):
    ...
    _prev_url, _next_url = _cfg.adjacent_urls("26_05_22/")
...
def _():
    ...
    RAW_BASE = "https://raw.githubusercontent.com/EEE-project/created_with_eee/main/modern_greek/b1greeklanguageandculture/kapodistrias/26_05_22"
