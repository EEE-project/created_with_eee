...
def _(mo, notebook_dir, os):
    ...
    mo.vstack([
        ...
        Ακολουθεί η σύνοψη των υλικών από την παρουσίαση [«Η ΕΛΛΑΔΑ ΠΟΥ ΒΡΗΚΕ Ο ΚΑΠΟΔΙΣΤΡΙΑΣ»](https://docs.google.com/presentation/d/1ra_DryijiIBPcuLHhWpiLp0U8nMp2b91/edit?usp=drive_link&ouid=114390708685640574713&rtpof=true&sd=true) και τις σημειώσεις του μαθήματος της 8/5/2026:
        """),
        _img(1),
        mo.md(r"""
