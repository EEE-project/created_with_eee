...
app = marimo.App(
    app_title="Καποδίστριας — Μάθημα 2 · 08/05/2026: Η Ελλάδα που Βρήκε ο Καποδίστριας",
    width="medium",
    ...
    if _lang == "ru":
        _c = mo.vstack([
            ...
            *   **Επίθετα:** οργανωμένος (организованный), κατεστραμμένος (разрушенный), ελεύθερος (свободный), ισχυρός (сильный), μορφωμένος (образованный).
            ...
            Материалы урока отражают усилия Каподистрии по превращению разрушенной страны в **современное и организованное европейское государство**.
            """),
        ])
    elif _lang == "el":
        _c = mo.vstack([
...
def _(language_selector, mo):
    ...
    _prev_url, _next_url = _cfg.adjacent_urls("26_05_08/")
...
def _():
    ...
    RAW_BASE = "https://raw.githubusercontent.com/EEE-project/created_with_eee/main/modern_greek/b1greeklanguageandculture/kapodistrias/26_05_08"
