...
def _(
    ...
    if words4test_noun() and _cn and (_cs or _ca):
        ...
        if _passed:
            ...
            set_noun_msg(f'<span style="color:green;">Test for <b>"{_cn["Word"]}"</b> completed.\n\n{len(_new)} words remaining out of {session_total_n()}.</span>')
...
def _(
    ...
    if _cv and _tense_key and _c and getattr(_c, 'verb_word', None) == _cv['Word'] and getattr(_c, 'tense', None) == _tense_key:
        ...
        if _ok:
            ...
            set_verb_msg(f'<span style="color:green;">Test for <b>"{_cv["Word"]} — {_cv["Translation"]}"</b> completed.\n\n{len(_new)} words remaining out of {session_total_v()}.</span>')
...
def _(
    ...
    if words4test_adj() and _adj and _c and getattr(_c, 'adj_word', None) == _adj['Word']:
        ...
        if adj_ok:
            ...
            set_adj_last_passed_mesg(f'<span style="color:green;">Test for <b>"{_adj["Word"]} — {_adj["Translation"]}"</b> completed.\n\n{len(_new)} words remaining out of {session_total_a()}.</span>')
