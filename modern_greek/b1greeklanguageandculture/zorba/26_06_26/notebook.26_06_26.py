...
app = marimo.App(
    app_title="Αλέξης Ζορμπάς — Μάθημα 1 · 26/06/2026: Ποιος είναι ο Αλέξης Ζορμπάς;",
    width="medium",
...
def _(RAW_BASE, gu, language_selector, mo, notebook_dir):
    ...
    if _lang == "ru":
        _c = mo.vstack([
            ...
            *   συνδέθηκε με την Ελλάδα → стал ассоциироваться с Грецией
            """),
        ])
    elif _lang == "el":
        _c = mo.vstack([
...
def _():
    ...
    RAW_BASE = "https://raw.githubusercontent.com/EEE-project/created_with_eee/main/modern_greek/b1greeklanguageandculture/zorba/26_06_26"
