...
app = marimo.App(
    app_title="Αλέξης Ζορμπάς — Μάθημα 4 · 17/07/2026: Τι μας δίδαξε τελικά ο Ζορμπάς;",
    width="medium",
...
def _(RAW_BASE, gu, language_selector, mo, notebook_dir):
    ...
    if _lang == "ru":
        _c = mo.vstack([
            ...
            _img(1),
            mo.md(r"""
            ### **Опишите Зорбаса одним словом**
            Если бы вам нужно было описать Зорбаса одним-единственным словом, каким бы оно было?
            """),
            _img(2),
            mo.md(r"""
            ...
            mo.md(r"""
            ### **Последний танец**
            Их планы провалились. Их мечта рухнула у них на глазах. И всё же… они танцуют!
            *   Почему они танцуют?
            *   Что показывает этот танец?
            *   Как мы справляемся с трудностями в жизни?
            """),
            _img(4),
            mo.md(r"""
            ### **Неудача**
            Их планы провалились. Что бы сделали вы?
            *   Как вы справляетесь с трудностями в жизни?
            """),
            _img(5),
            mo.md(r"""
            ### **Жизнь**
            *«Жизнь — это не только думать о ней. Это ещё и жить ею.»*
            — Никос Казандзакис
            ...
            mo.md(r"""
            ### **Занятие 17/7/2026**
            *   συνηθισμένος άνθρωπος → обычный человек
            *   αντιμετωπίζω προβλήματα → сталкиваться с проблемами, справляться с трудностями
            ...
            *   το πρόβλημα → проблема
            ...
            ### **Глаголы**
            *   αντιμετωπίζω → сталкиваться (с чем-л.), справляться (с чем-л.)
            ...
            *   αισιόδοξος → оптимистичный
            ...
            ### **Примеры**
            1.  **Ο Ζορμπάς δεν ήταν συνηθισμένος άνθρωπος.** — Зорбас не был обычным человеком.
            2.  **Πώς αντιμετωπίζετε τα προβλήματα;** — Как вы справляетесь с проблемами?
            3.  **Είμαι αισιόδοξος για τη ζωή.** — Я оптимистично настроен по поводу жизни.
            """),
        ])
    elif _lang == "el":
        _c = mo.vstack([
            ...
            _img(1),
            mo.md(r"""
            ### **Περιγράψτε τον Ζορμπά με μία λέξη**
            Αν έπρεπε να περιγράψετε τον Ζορμπά με μία μόνο λέξη, ποια θα ήταν;
            """),
            _img(2),
            mo.md(r"""
            ...
            mo.md(r"""
            ### **Ο τελευταίος χορός**
            Τα σχέδιά τους απέτυχαν. Το όνειρό τους γκρεμίστηκε μπροστά στα μάτια τους. Κι όμως… χορεύουν!
            *   Γιατί χορεύουν;
            *   Τι δείχνει αυτός ο χορός;
            *   Πώς αντιμετωπίζουμε τις δυσκολίες στη ζωή;
            """),
            _img(4),
            mo.md(r"""
            ### **Η αποτυχία**
            Τα σχέδιά τους απέτυχαν. Τι θα κάνατε εσείς;
            *   Πώς αντιμετωπίζετε τις δυσκολίες στη ζωή;
            """),
            _img(5),
            mo.md(r"""
            ### **Η ζωή**
            *«Η ζωή δεν είναι μόνο να τη σκεφτόμαστε. Είναι και να τη ζούμε.»*
            — Νίκος Καζαντζάκης
            ...
            *   αισιόδοξος
            ...
            ### **Παραδείγματα**
            1.  **Ο Ζορμπάς δεν ήταν συνηθισμένος άνθρωπος.**
            2.  **Πώς αντιμετωπίζετε τα προβλήματα;**
            3.  **Είμαι αισιόδοξος για τη ζωή.**
            """),
        ])
    else:
        _c = mo.vstack([
            ...
            _img(1),
            mo.md(r"""
            ### **Describe Zorbas in One Word**
            If you had to describe Zorbas in a single word, what would it be?
            """),
            _img(2),
            mo.md(r"""
            ...
            mo.md(r"""
            ### **The Last Dance**
            Their plans failed. Their dream collapsed before their eyes. And yet… they dance!
            *   Why do they dance?
            *   What does this dance show?
            *   How do we face difficulties in life?
            """),
            _img(4),
            mo.md(r"""
            ### **Failure**
            Their plans failed. What would you do?
            *   How do you face difficulties in life?
            """),
            _img(5),
            mo.md(r"""
            ### **Life**
            *"Life is not only to be thought about. It is also to be lived."*
            — Nikos Kazantzakis
            ...
            mo.md(r"""
            ### **Session 17/7/2026**
            *   συνηθισμένος άνθρωπος → ordinary person
            *   αντιμετωπίζω προβλήματα → to face/deal with problems
            ...
            *   το πρόβλημα → problem
            ...
            ### **Verbs**
            *   αντιμετωπίζω → to face, to deal with

            ### **Adjectives**
            *   συνηθισμένος → ordinary, usual
            *   αισιόδοξος → optimistic

            ### **Examples**
            1.  **Ο Ζορμπάς δεν ήταν συνηθισμένος άνθρωπος.** — Zorbas was not an ordinary person.
            2.  **Πώς αντιμετωπίζετε τα προβλήματα;** — How do you deal with problems?
            3.  **Είμαι αισιόδοξος για τη ζωή.** — I am optimistic about life.
            """),
        ])
    _c
    return
...
def _():
    ...
    RAW_BASE = "https://raw.githubusercontent.com/EEE-project/created_with_eee/main/modern_greek/b1greeklanguageandculture/zorba/26_07_17"
