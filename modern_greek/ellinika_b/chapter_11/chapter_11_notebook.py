...
app = marimo.App(width="medium", html_head_file="head.html", app_title="Ελληνικά Β1 — Chapter 11: Shall We Go on Holiday?")
...
def _(language_selector, mo):
    ...
    **Τεστ:** Ουσιαστικά · Ρήματα · Επίθετα
    """)
        ...
        _out = mo.md(f"""
    # «Πάμε διακοπές;» ✈️
    ## Unit 11 — Shall We Go on Holiday? · B1
...
def _(language_selector, mo):
    ...
    Απλή Υποτακτική образуется на основе перфективного (аористного) вида — с той же формой основы, которая используется в Простом будущем. Вместо θα используются частицы να или ας.

    > θα αγοράσω (Простое будущее) → **να αγοράσω** (Υποτακτική)

    Απλή Υποτακτική обычно образуется с частицей **να** + перфективная форма глагола: **να κάνω**, **να πάμε**, **να έρθω**. В некоторых конструкциях **να** заменяется или не употребляется, например после **ας** и **μη(ν)/μήπως**.

    ### Когда используется

    | Греческий | Русский | Пример |
    |:------|:--------|:--------|
    | **Θέλω / θα ήθελα** | хочу / хотел(а) бы | Θέλω/θα ήθελα **να κάνω** ένα μεγάλο ταξίδι με τρένο. («Хочу / хотел(а) бы совершить большое путешествие на поезде.») |
    | **Πρέπει** | нужно / должен | Πρέπει **να ψάξουμε** για δωμάτιο. («Нам нужно поискать номер.») |
    | **Πρόκειται** | собираюсь / намереваюсь | Πρόκειται **να πάω** στην Ιαπωνία. («Я собираюсь поехать в Японию.») |
    | **Μπορεί** | может быть / возможно | Μπορεί **να μη βρούμε** εισιτήρια. («Может быть, мы не найдём билеты.») |
    | **Μπορώ** | могу | Δεν μπορώ **να έρθω** μαζί σας. («Я не могу пойти с вами.») |
    | **Ελπίζω** | надеюсь | Ελπίζω **να έρθετε** μαζί μας. («Надеюсь, вы придёте с нами.») |
    | **Λέω** | думаю / собираюсь | Λέω **να πάω** διακοπές στη Νάξο. («Я подумываю поехать в отпуск на Наксос.») |
    | **Προτιμώ** | предпочитаю | Προτιμώ **να μη φάω** τώρα. («Я предпочитаю сейчас не есть.») |
    | **Προτείνω** | предлагаю | Προτείνω **να πάμε** στο Μαρόκο. («Я предлагаю поехать в Марокко.») |
    | **Σκοπεύω** | намереваюсь | Σκοπεύω **να μείνω** αρκετό καιρό. («Я намереваюсь остаться надолго.») |
    | **Είναι ανάγκη** | необходимо / нужно | Είναι ανάγκη **να σε δω** σήμερα. («Мне необходимо увидеть тебя сегодня.») |
    | **Είναι ώρα** | пора | Είναι ώρα **να φύγω**. («Мне пора уходить.») |
    | **χωρίς να** | не делая чего-либо / не... | Γιατί έκλεισες εισιτήρια **χωρίς να** με ρωτήσεις; («Почему ты забронировал(а) билеты, не спросив меня?») |
    | **ας** | пусть / давайте | **Ας πάμε** όλοι μαζί! / **Ας φύγει**. («Давайте пойдём все вместе! / Пусть уходит.») |
    ...
    **Отрицание:** Λέω **να μη** βγούμε. / Σκέφτομαι **να μην** πάω πουθενά.
    ...
    Η Απλή Υποτακτική χρησιμοποιεί το **συνοπτικό (αοριστικό) θέμα** — το ίδιο θέμα με τον Απλό Μέλλοντα — και εισάγεται με **να** ή **ας** αντί για **θα**.
    ...
    |:------|:--------|:--------|
    | **Θέλω / θα ήθελα** | I want / I would like | Θέλω/θα ήθελα **να κάνω** ένα μεγάλο ταξίδι με τρένο. ("I want / would like to take a big trip by train.") |
    | **Πρέπει** | I/you must | Πρέπει **να ψάξουμε** για δωμάτιο. ("We need to look for a room.") |
    | **Πρόκειται** | I'm going to | Πρόκειται **να πάω** στην Ιαπωνία. ("I'm going to go to Japan.") |
    | **Μπορεί** | maybe / it's possible | Μπορεί **να μη βρούμε** εισιτήρια. ("We might not find tickets.") |
    | **Μπορώ** | I can | Δεν μπορώ **να έρθω** μαζί σας. ("I can't come with you.") |
    | **Ελπίζω** | I hope | Ελπίζω **να έρθετε** μαζί μας. ("I hope you'll come with us.") |
    | **Λέω** | I'm thinking of | Λέω **να πάω** διακοπές στη Νάξο. ("I'm thinking of going on vacation to Naxos.") |
    | **Προτιμώ** | I prefer | Προτιμώ **να μη φάω** τώρα. ("I prefer not to eat now.") |
    | **Προτείνω** | I suggest | Προτείνω **να πάμε** στο Μαρόκο. ("I suggest we go to Morocco.") |
    | **Σκοπεύω** | I intend | Σκοπεύω **να μείνω** αρκετό καιρό. ("I intend to stay quite a while.") |
    | **Είναι ανάγκη** | it's necessary | Είναι ανάγκη **να σε δω** σήμερα. ("I need to see you today.") |
    | **Είναι ώρα** | it's time | Είναι ώρα **να φύγω**. ("It's time for me to go.") |
    | **χωρίς να** | without | Γιατί έκλεισες εισιτήρια **χωρίς να** με ρωτήσεις; ("Why did you book tickets without asking me?") |
    | **ας** | let's / let him | **Ας πάμε** όλοι μαζί! / **Ας φύγει**. ("Let's all go together! / Let him leave.") |
    ...
    **Άρνηση:** Λέω **να μη** βγούμε. / Σκέφτομαι **να μην** πάω πουθενά.
    ...
    The Simple Subjunctive uses the **perfective (aorist) stem** — the same stem as the Simple Future — introduced by **να** or **ας** instead of **θα**.
...
def _(language_selector, mo):
    ...
    **Αν + основа Простого будущего → Простое будущее** (реальное/открытое условие):
    ...
    **Αν + основа Простого будущего → Υποτακτική** (приглашение, совет или предложение):
    ...
    **Αν + θέμα Απλού Μέλλοντα → Απλός Μέλλοντας** (πραγματική/ανοιχτή υπόθεση):
    ...
    **Αν + θέμα Απλού Μέλλοντα → Υποτακτική** (πρόσκληση, συμβουλή ή πρόταση):
    ...
    **Αν + Simple Future stem → Simple Future** (open/future condition):

    | Condition | Result | Translation |
    |:----------|:-------|:-------------|
    | **Αν** *έρθετε* στην Ελλάδα τον Ιούνιο, | *θα βρείτε* κάτι καλό και οικονομικό. | If you come to Greece in June, you'll find something good and affordable. |

    **Αν + Simple Future stem → Subjunctive** (invitation, advice, or suggestion):
...
def _():
    ...
    RAW_BASE = "https://raw.githubusercontent.com/EEE-project/created_with_eee/main/modern_greek/ellinika_b/chapter_11"
