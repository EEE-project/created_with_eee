...
def _(language_selector, mo):
    ...
    |:-------------------------------------------------|:--------------------------------------------------|
    | Μπορείς **να φας** ό,τι θέλεις σήμερα. ("Ты можешь съесть, что хочешь, сегодня.") | Μπορείς **να τρως** ό,τι θέλεις από αύριο. ("Ты можешь есть, что хочешь, начиная с завтра.") |
