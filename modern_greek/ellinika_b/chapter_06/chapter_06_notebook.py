...
def _(language_selector, mo):
    ...
    _badge = "[![Open in molab](https://molab.marimo.io/molab-shield.svg)](https://molab.marimo.io/notebooks/nb_XGhhCiokHqkThf7YSmR7gX)"
    if _lang == "ru":
...
def _():
    ...
    _UI_STRINGS = {
        "en": {
            ...
            "simple_noun_heading": "**Simple test for nouns**",
            "article_noun_heading": "**Test for nouns with articles**",
