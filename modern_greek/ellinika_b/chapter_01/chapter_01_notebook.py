...
app = marimo.App(width="medium", app_title="Ελληνικά Β1 — Chapter 1: Leave Your Message")
...
def _(language_selector, mo):
    ...
    if _lang == 'ru':
        ...
        | Α, και πού 'σαι... | Ах, и вот ещё что... |
        ...
        | Θα ήθελα να μιλήσω στον κύριο Οικονόμου, παρακαλώ. | Я хотел бы поговорить с господином Икономоу, пожалуйста. |
        | Μπορώ να μιλήσω στον κύριο Οικονόμου; | Могу я поговорить с господином Икономоу? |
        ...
        | Λάθος πήρατε. Δεν υπάρχει κύριος Οικονόμου εδώ. | Вы ошиблись номером. Здесь нет господина Икономоу. |
        | Μάλλον κάνατε λάθος. | Вы, наверное, ошиблись. |
        | Ο κύριος Οικονόμου; / Η κυρία Αντωνοπούλου; → Ο ίδιος. / Η ίδια. | Господин Икономоу? / Госпожа Андонопулу? → Это я. |
...
def _():
    ...
    RAW_BASE = "https://raw.githubusercontent.com/EEE-project/created_with_eee/main/modern_greek/ellinika_b/chapter_01"
