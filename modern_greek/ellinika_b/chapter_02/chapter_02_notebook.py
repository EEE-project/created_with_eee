...
app = marimo.App(width="medium", app_title="Ελληνικά Β1 — Chapter 2: My Home Sweet Home")
...
def _(language_selector, mo):
    ...
    if _lang == 'ru':
        ...
        | Ποιανού είναι το σπίτι; | Чей это дом? |
        | Εμένα μου αρέσει. Εσένα; | Мне он нравится. А тебе? |
        ...
        | Γυρίζει όλον τον κόσμο. | Она объезжает весь мир. |
...
def _():
    ...
    RAW_BASE = "https://raw.githubusercontent.com/EEE-project/created_with_eee/main/modern_greek/ellinika_b/chapter_02"
