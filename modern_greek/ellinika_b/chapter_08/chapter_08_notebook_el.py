...
def _(mo):
    ...
    > **Σε αντίθεση με τον Συνεχή Μέλλοντα** (θα + Ενεστώτας): *θα αγοράζω* = θα συνεχίζω να αγοράζω (επαναλαμβανόμενα).
...
def _(df_noun, mo, tbl_sel_n):
    ...
    _display = table_noun if table_noun is not None else mo.md("_Το αρχείο nouns.tsv δεν βρέθηκε — φόρτωσε αρχείο._")
...
def _(df_verb, mo, tbl_sel_v):
    ...
    _display = table_verb if table_verb is not None else mo.md("_Το αρχείο verbs.tsv δεν βρέθηκε — φόρτωσε αρχείο._")
...
def _(df_adj, mo, tbl_sel_a):
    ...
    _display = table_adj if table_adj is not None else mo.md("_Το αρχείο adjectives.tsv δεν βρέθηκε — φόρτωσε αρχείο._")
