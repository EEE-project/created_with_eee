...
def _(mo):
    ...
    **More adjectives of this type:**
    πενηντάρης · κοκκινομάλλης · γαλανομάτης · μικρούλης · ναζιάρης · κουτσομπόλης
    """)
    return
...
def _(df_noun, gu, mo, tbl_sel_n):
    ...
    _display = table_noun if table_noun is not None else mo.md("_nouns.tsv not found — upload a file to begin._")
...
def _(df_verb, gu, mo, tbl_sel_v):
    ...
    _display = table_verb if table_verb is not None else mo.md("_verbs.tsv not found — upload a file to begin._")
...
def _(df_adj, gu, mo, tbl_sel_a):
    ...
    _display = table_adj if table_adj is not None else mo.md("_adjectives.tsv not found — upload a file to begin._")
