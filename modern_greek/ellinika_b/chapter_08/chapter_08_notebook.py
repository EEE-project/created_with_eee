...
app = marimo.App(width="medium", html_head_file="head.html", app_title="Ελληνικά Β1 — Chapter 8: Weather is Changeable")
...
def _(language_selector, mo):
    ...
    | Πώς κάνεις έτσι; | Почему ты так себя ведёшь? |
...
def _(language_selector, mo):
    ...
    **Направления ветра:** βοριάς (С) · νοτιάς (Ю) · ανατολικός άνεμος (В) · δυτικός άνεμος (З)
    ...
    **Κατευθύνσεις ανέμου:** βοριάς (Β) · νοτιάς (Ν) · ανατολικός άνεμος (Α) · δυτικός άνεμος (Δ)
    ...
    **Wind directions:** βοριάς (N) · νοτιάς (S) · ανατολικός άνεμος (E) · δυτικός άνεμος (W)
...
def _(language_selector, mo):
    ...
    Представляет будущее действие как **единое** событие, а не как длительное или повторяющееся.
    ...
    > **Ср. Συνεχής Μέλλοντας** (θα + настоящее): *θα αγοράζω* = буду покупать (длительно / регулярно, а не только «много раз»).
    ...
    Παρουσιάζει μια μελλοντική πράξη ως **ενιαίο** γεγονός, όχι ως συνεχιζόμενη ή επαναλαμβανόμενη.
    ...
    > **Σε αντίθεση με τον Συνεχή Μέλλοντα** (θα + Ενεστώτας): *θα αγοράζω* = διαρκής ή συνηθισμένη μελλοντική πράξη.
    ...
    Presents a future action as a **single** event, rather than an ongoing or repeated one.
    ...
    > **Vs. Συνεχής Μέλλοντας** (θα + Present): *θα αγοράζω* = I will be buying / will buy regularly (ongoing or habitual, not just repeated).
...
def _(language_selector, mo):
    ...
    **Αν** + Простое будущее (без **θα**) → **θα** + Простое будущее
    ...
    | Αν **αρχίσεις** γυμναστική, **θα νιώσεις** πολύ καλύτερα. | Если ты начнёшь заниматься спортом, ты почувствуешь себя намного лучше. |
    | Αν **έρθεις**, **θα φάμε** μαζί το μεσημέρι. | Если ты придёшь, мы вместе пообедаем. |
    | Αν **διαβάσεις** περισσότερο, **θα περάσεις** στις εξετάσεις. | Если ты будешь больше заниматься, ты сдашь экзамены. |
    | Αν του **τηλεφωνήσεις** τώρα, **θα τον βρεις**. | Если ты позвонишь ему сейчас, ты застанешь его. |
    """)
    elif _lang == "el":
        _out = mo.md("""
...
def _(language_selector, mo):
    ...
    Многие прилагательные этого типа имеют разговорную или экспрессивную окраску и часто описывают человека, его внешность, возраст или черты характера.
    ...
    **Склонение τεμπέλης:**
    ...
    | Рд. | τεμπέλη / τεμπέληδων | τεμπέλας / — | τεμπέλικου / τεμπέλικων |
    ...
    **Другие прилагательные этого типа:**
    πενηντάρης · κοκκινομάλλης · γαλανομάτης · μικρούλης · ναζιάρης · κουτσομπόλης · τσιγκούνης · φοβητσιάρης · παιχνιδιάρης
    """)
    elif _lang == "el":
        _out = mo.md("""
    ## Γραμματική: Επίθετα σε **-ης, -α, -ικο**

    Πολλά επίθετα αυτού του τύπου έχουν εκφραστικό ή καθομιλούμενο ύφος και συχνά περιγράφουν έναν άνθρωπο, την εμφάνισή του, την ηλικία ή τον χαρακτήρα του.
    ...
    **Κλίση του τεμπέλης:**
    ...
    | Γεν. | τεμπέλη / τεμπέληδων | τεμπέλας / — | τεμπέλικου / τεμπέλικων |
    ...
    **Άλλα επίθετα αυτού του τύπου:**
    ...
    Many adjectives of this type carry an expressive or colloquial tone and often describe a person's appearance, age, or character.
    ...
    **Declension of τεμπέλης:**
    ...
    | Gen. | τεμπέλη / τεμπέληδων | τεμπέλας / — | τεμπέλικου / τεμπέλικων |
...
def _(language_selector, mo):
    ...
    _prev_url, _next_url = _cfg.adjacent_urls("chapter_08/")
