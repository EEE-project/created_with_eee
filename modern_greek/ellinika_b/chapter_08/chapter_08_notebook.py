...
def _(language_selector, mo):
    ...
    **Τι καιρό κάνει τώρα εκεί;** Βρέχει (идёт дождь). Ψιλοβρέχει (слегка моросит). Ψιχαλίζει (моросит). Χιονίζει (идёт снег). Ρίχνει χιόνι. Ρίχνει χαλάζι (идёт град). Φυσάει (дует ветер). Έχει αστραπές και βροντές/μπουμπουνητά (сверкают молнии и гремит гром). Αστράφτει. Βροντάει/Μπουμπουνίζει.

    **Τι καιρό είχατε χτες;** Έβρεχε συνέχεια. Ο δρόμος μπροστά στο σπίτι έγινε ποτάμι και η αποθήκη μας πλημμύρισε. Όλη τη νύχτα δεν μπορέσαμε να ησυχάσουμε από τις αστραπές και τις βροντές. Ένας κεραυνός έπεσε σε ένα δέντρο δίπλα στο σπίτι μας και το έκαψε. — _Всё время шёл дождь. Улица перед нашим домом превратилась в реку, и наш склад затопило. Всю ночь мы не могли успокоиться от молний и грома. Молния ударила в дерево рядом с нашим домом и сожгла его._
