...
def _(language_selector, mo):
    ...
    Многие прилагательные этого типа описывают личные черты характера и часто имеют экспрессивную или разговорную окраску.
    ...
    **Другие прилагательные этого типа:**
    ...
    Πολλά επίθετα αυτού του τύπου περιγράφουν προσωπικά χαρακτηριστικά και συχνά έχουν εκφραστικό ή καθομιλούμενο ύφος.
    ...
    **Άλλα επίθετα αυτού του τύπου:**
    ...
    Many adjectives of this type describe personal characteristics and often carry an expressive or colloquial tone.
